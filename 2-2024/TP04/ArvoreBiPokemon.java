...
class No {
    ...
    public No esq, dir; // Filhos da esquerda e direita.
    public boolean cor; // Verdadeiro para vermelho, falso para preto.
    ...
    public No(Pokemon elemento) {
        this(elemento, null, null, true); // Nós são inicialmente vermelhos.
    }

    /**
     * Construtor da classe.
     * @param elemento Conteúdo do nó.
     * @param esq Filho da esquerda.
     * @param dir Filho da direita.
     * @param cor Cor do nó.
     */
...
class ArvoreBicolor {
    ...
    /**
     * Insere um elemento na árvore bicolor.
    ...
    private No inserir(Pokemon x, No i) throws Exception {
        if (i == null) {
            return new No(x); // Novo nó é vermelho.
        }
        ...
        // Ajusta as cores e realiza rotações, se necessário.
        i = balancear(i);
        return i;
    }
    ...
    private No balancear(No i) {
        // Verifica e corrige violações das propriedades da árvore bicolor.
    ...
    private boolean isRed(No i) {
        return i != null && i.cor == true;
    }

    private No rotacaoEsquerda(No i) {
        No temp = i.dir;
        i.dir = temp.esq;
        temp.esq = i;
        temp.cor = i.cor;
    ...
    private No rotacaoDireita(No i) {
        No temp = i.esq;
        i.esq = temp.dir;
        temp.dir = i;
        temp.cor = i.cor;
    ...
    private void inverterCores(No i) {
        i.cor = !i.cor;
        if (i.esq != null) i.esq.cor = !i.esq.cor;
        if (i.dir != null) i.dir.cor = !i.dir.cor;
    }

    /**
     * Pesquisa um elemento na árvore.
     * @param x Nome do Pokémon a ser pesquisado.
     */
...
public class ArvoreBiPokemon {
    public static void main(String[] args) {
        try {
            long inicio = System.currentTimeMillis();
            PrintWriter log = new PrintWriter("859230_avinegra.txt");
