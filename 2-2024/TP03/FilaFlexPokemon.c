...
//utilizando variaveis globais
Celula* primeiro;
Celula* ultimo;
int tamanho;//registra o tamanho da lista
...
int tamanhoL() {
    tamanho = 0;
    Celula* i;
    for (i = primeiro->prox; i != ultimo; i = i->prox, tamanho++);
    return tamanho;
}
